...
<base href="${xKeycloakify.resourcesPath}/dist/">
    ...
    <title>TFM Keycloak Theme Preview</title>
    <script type="module" crossorigin="" src="${xKeycloakify.resourcesPath}/dist/assets/index-CUD4ha5I.js"></script>
    <link rel="stylesheet" crossorigin="" href="${xKeycloakify.resourcesPath}/dist/assets/index-jCkTEMAa.css">
  </head>
  <body>
    <div id="root"></div>
